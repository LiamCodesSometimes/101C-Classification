...
| Model 7   |    Random Forest | ranger  | Pavan | mtry = 98, trees = 50, min_n = 1 |
...
|------------|--------|---------|---------|---------|--------|--------|---------|
|**Accuracy**| 0.933 | 0.85355 |  0.9960 | 0.89539| 0.94560 | 0.94142 | 0.91205 |
|**Std. Error**|  0.0044 |0.0058 | 0.0044  |0.005247| 0.0052123 | 0.0065 | 0.003404|
...
model_performance <- data.frame(
  ...
  Accuracy_metric = c(0.933, 0.85355, 0.9960, 0.89539, 0.9456, 0.94142, 0.91205)
)
...
model_performance <- data.frame(
  Model = c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6", "Model 7"),
  Accuracy_metric = c(0.0044, 0.0058, 0.0044, 0.005247, 0.005212, 0.0065, 0.003404)
)
