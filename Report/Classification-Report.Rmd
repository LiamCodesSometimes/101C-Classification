...
**TODO:** Finish this (i.e. explain why recipes were not used)

Preprocessing and recipes were not used for the final model. While there was a model that attempted to use a recipe, it somehow performed worse than the unadjusted model.
...
| Model 7   |    Random Forest |   | Pavan | N/A |
...
**Model 5** was chosen as the final model due to the fact that it had the best performance in terms of accuracy. Despite the fact that it literally does not contain any pre-processing steps, it still performed the best among all the candidate models. 

## Hypertuning Process

**TODO:** Write details explaining process
...
**TODO:** Add whatever you think would be interesting
...
While these issues were attempted to be resolved in **Model 6**, this somehow resulted in a slightly less accurate model. These attempts could further be improved in future recipes.

**TODO:** Elaborate on this and talk about your attempt in making the stack
Also, we could attempt to use the stack. 


## Additional Data
**TODO:** Add whatever you think would be useful
...
- Eric: Created tables in report, added some insight in discussions, created KNN models, created a recipe for **Model 5**, documented findings on EDA of column types
...
- Ava:  Creation of some exploratory data analysis visuals, creation of a candidate model, compiled information for the report, created tables in report
- Liam: Created **Model 5**, attempted stack, wrote about **Model 5** on report
- Pavan: Half of exploratory data analysis, created random forest model
