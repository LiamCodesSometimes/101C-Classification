...
For starters, we can tune $k$ as well as increase the number of $v$ folds. Furthermore, there are more ways we can deal with interaction effects between age categories (for instance ages per gender amy interact with general age columns).
